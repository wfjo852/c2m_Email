...
def mail_send(mail_token,to,sub_text,msg_text="",html_return="",file_return=""):
...
# mail_send(mail_token_meta,'wfjo852@gmail.com',"치매 극복 인지훈련 콘텐츠('메타360','VR기억산책') 신규 업데이트 소식!!",html_result,file_result)
